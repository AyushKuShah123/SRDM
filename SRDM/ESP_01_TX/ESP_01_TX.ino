...
// //8C:AA:B5:69:2B:05 /// ESP 01
// uint8_t broadcastAddress[] = {0x8C, 0xAA, 0xB5, 0x69, 0x2B, 0x05};
...
void loop() {
  ...
  float temperature = dht.readTemperature();
 // pms.wakeUp();
  delay(300); // Delay to ensure stable sensor readings
  pms.readUntil(data);
  ...
  if ((millis() - lastTime) > timerDelay) {
    ...
    myData.spm1 = "PM1.0";
    myData.pm1 = static_cast<float>(data.PM_AE_UG_1_0);
    myData.spm25 = "PM2.5";
    myData.pm25 = static_cast<float>(data.PM_AE_UG_2_5);
    myData.spm10 = "PM10.0";
    myData.pm10 = static_cast<float>(data.PM_AE_UG_10_0);
